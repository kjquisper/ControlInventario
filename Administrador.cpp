...
Administrador::Administrador(char u[],char c[],char d[])
{
    strcpy(usuario,u);
    strcpy(contrasena,c);
    strcpy(DNI,d);
...
void Administrador::Obtener_Longitud()
{
...
bool Administrador::Validar_Datos(char Dato1[],int Num_Dato1, char Dato2[], int Num_Dato2)
{
    bool Aprobado=false;
    int Conteo=0;
